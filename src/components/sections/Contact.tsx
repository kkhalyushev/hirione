...
export function Contact() {
    ...
    return (
        <section id="contact" className="py-32 overflow-hidden relative bg-background">
            ...
            <div className="container mx-auto px-4 text-center md:px-6 relative z-10">
                ...
                <motion.h2
                    ...
                    viewport={{ once: true }}
                    className="mb-16 text-xs sm:text-sm font-medium tracking-[0.2em] uppercase text-muted-foreground"
                >
                    {t.header}
                </motion.h2>
                ...
                <div className="flex flex-col items-center gap-6 mb-24">
                    ...
                    >
                        ...
                        >
                            <span className="text-4xl sm:text-6xl md:text-7xl font-serif font-medium text-foreground transition-colors group-hover:text-primary">
                                {t.telegramValue}
                            </span>
                    ...
                    >
                        <Link
                            ...
                            className="group relative inline-block"
                        >
                            <span className="text-2xl sm:text-4xl md:text-5xl font-serif font-medium text-muted-foreground transition-colors group-hover:text-foreground">
                                {t.emailValue}
                            </span>
                            <span className="absolute -bottom-2 left-0 w-0 h-[1px] bg-primary transition-all duration-300 group-hover:w-full" />
                        </Link>
...
function SocialLink({ href, icon, label }: { href: string; icon: React.ReactNode; label: string }) {
    return (
        <Link
            ...
            aria-label={label}
        >
            <div className="flex h-14 w-14 items-center justify-center rounded-full border border-border bg-white text-muted-foreground shadow-sm transition-all duration-300 group-hover:scale-110 group-hover:border-primary group-hover:text-primary">
                {icon}
            </div>
        </Link>
    );
